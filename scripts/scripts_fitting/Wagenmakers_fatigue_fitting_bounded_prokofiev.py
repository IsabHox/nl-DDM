# -*- coding: utf-8 -*-
"""
Created on Thu Nov 17 14:04:49 2022
...
#%% Instanciate models for fitting the accuracy condition
    ...
    non_lin_model_acc=Model(name="my model", drift=nlddmFatigue(k1=Fittable(minval = .1, maxval = 10),
             ...
             # IC = ICPoint(x0=Fittable(minval=0, maxval=0.1)),
              overlay = OverlayChain(overlays=[OverlayNonDecision(nondectime=Fittable(minval = 0.1, maxval = 0.8)), #halfwidth=Fittable(minval=0., maxval=0.2)),
    ...
    # s+=1
#%%
    results_df.to_csv(f'../../results/fitting_Wagenmakers_fatigue_bounded_{subject}.csv')

    performance.to_csv(f'../../results/performance_Wagenmakers_fatigue_bounded_{subject}.csv')
